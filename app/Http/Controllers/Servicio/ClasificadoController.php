...
class ClasificadoController extends Controller
{
    ...
    public function index()
    {
          ...
          return view('usuario.clasificado.ver',[ 'clasificados' => $clasificados] );
    }

    public function indexadmin()
    {
          $clasificados = Clasificado::orderBy('id', 'desc')->get();
          return view('admin_clasificado.clasificados',[ 'clasificados' => $clasificados] );
    }

    public function create()
    {
        $clasificados = Clasificado::all()->where('user_id',Auth::user()->id);
        return view('usuario.clasificado.add',[ 'clasificados' => $clasificados]);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin_clasificado.ver',compact('clasificado'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin_clasificado.update',compact('clasificado'), [ 'estados' => $estados]);
    }
