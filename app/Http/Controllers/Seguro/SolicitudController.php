...
class SolicitudController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('usuario.seguro.solicitud', ['seguro_productos' => $seguro_productos]);
    }
    ...
    public function segurosvista()
    {
      ...
      $seguros = Seguro::all()->where('user_id', Auth::user()->id);
      return view('usuario.seguro.seguros',compact('cantarchitotal'),[ 'seguros' => $seguros]);
    ...
    public function segurosvistaestado($id)
    {
      ...
      return view('usuario.seguro.seguros',compact('cantarchitotal'),[ 'segurosarchivos' => $segurosarchivos,]);
    }
    ...
    public function info($id)
    {
        ...
        return view('usuario.seguro.info', compact('seguro_producto','public_path'),['seg_documentos' => $seg_documentos]);
    }
    ...
    {
        $seguro_producto = Seguros_producto::find($id);
        return view('usuario.seguro.terminos', compact('seguro_producto'));
    }
    ...
    public function show($id)
    {
        ...
        return view('usuario.seguro.ver', compact('seguro'),['segurosarchivos' => $segurosarchivos, 'estados' => $estados]);
    }
    ...
    public function edit($id)
    {
      ...
      return view('usuario.seguro.documentos', compact('segurouser','segurosarchivos'),['seg_documentos' => $seg_documentos]);
