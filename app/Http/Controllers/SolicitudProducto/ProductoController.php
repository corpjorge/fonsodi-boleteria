...
class ProductoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('solicitud_producto.producto.index', ['productos' => $productos] ); 
    ...
    public function actualizar()
    {
      ...
      $url_cartera = "http://190.145.4.62/WebServicesFonsodi/WSEstadoCuenta.asmx/PoblarListaDesplegable?pTabla=LINEASCREDITO&pColumnas=COD_LINEA_CREDITO,NOMBRE&pCondicion=ESTADO=1&pOrden=NOMBRE";
    ...
    public function create()
    {
        ...
        return view('solicitud_producto.producto.add', ['productos' => $productos]); 
    }
    ...
    public function edit($id)
    {
        ...
        return view('solicitud_producto.producto.edit', compact('producto', 'user')); 
    }
