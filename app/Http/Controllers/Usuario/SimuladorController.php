...
class SimuladorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('usuario.simulador.simulador',[ 'lineas' => $lineas, 'tasas' => $tasas]);
    }
    ...
    if($request->meses == 0){
      ...
      return view('usuario.simulador.simulador_resultado',
    ...
    public function invoice(Request $request)
      {
       ...
       if($request->meses == 0){
        ...
        $view =  \View::make('usuario.simulador.simulador_resultado_pdf', [ 'monto' => $monto, 'total' => $total,
          'interesT' => $interesT, 'meses' => $meses, 'final' => $final,
          'mes' => $mes, 'cuota' => $cuota, 'mesa' => $mesa, 'nombretasa' => $nombretasa,
          'valortasa' => $valortasa, 'idline' => $idline, 'valortasaanual' => $valortasaanual
        ]);
