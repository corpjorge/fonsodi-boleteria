...
class EventoController extends Controller
{
    ...
    {
        return view('usuario.evento.calendario');
    }
    public function indexadmin()
    {
        $eventos  = Evento::all();
        return view('admin_evento.evento',[ 'eventos' => $eventos]);
    }
    public function inscrip()
    {
      $eventos  = Evento::all()->where('estado_id', 1);
      return view('usuario.evento.evento',[ 'eventos' => $eventos]);
    }
    ...
    public function create()
    {
      $ciudades  = Ciudad::all();
      $estados  = Estado::all();
      return view('admin_evento.add',[ 'ciudades' => $ciudades, 'estados' => $estados ]);
    }
    ...
    public function show($id)
    {
      ...
      return view('usuario.evento.info', compact('evento'));
    }
    ...
    public function edit($id)
    {
      ...
      $ciudades  = Ciudad::all();
      $estados  = Estado::all();
      return view('admin_evento.update',[ 'ciudades' => $ciudades, 'estados' => $estados, 'evento' => $evento ]);
