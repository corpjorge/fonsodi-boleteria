...
class ProveedorController extends Controller
{
    ...
    public function linea(Request $request)
    {
      /*
        ...
        $url_lineas ="http://190.145.4.62/WebServicesFonsodi/WSEstadoCuenta.asmx/PoblarListaDesplegable?pTabla=lineascredito&pColumnas=cod_linea_credito,nombre&pCondicion=cod_linea_credito=".$request->codigo."&pOrden=cod_linea_credito";
    ...
    public function store(Request $request)
    {
      ...
      return redirect('admin_boleteria/proveedores');
        ...
        $url_proveedor = "http://190.145.4.62/WebServicesFonsodi/WSEstadoCuenta.asmx/PoblarListaDesplegable?pTabla=destinacion&pColumnas=cod_destino,descripcion&pCondicion=cod_destino=".$request->codigo."&pOrden=cod_destino";
