...
class ProductosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin_boleteria.productos.productos',[ 'productos' => $productos]);
    }
    ...
    public function create()
    {
        ...
        return view('admin_boleteria.productos.add',[ 'proveedores' => $proveedores]);
    }
    ...
    public function show($id)
    {
      ...
      return view('admin_boleteria.productos.ver', compact('producto'));
    }
    ...
    public function edit($id)
    {
      ...
      return view('admin_boleteria.productos.update', compact('producto'), ['proveedores' => $proveedores] );
    }
