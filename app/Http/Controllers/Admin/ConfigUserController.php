...
class ConfigUserController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('admin.user.user',[ 'adminUsers' => $adminUsers]);
    ...
    public function create()
    {
        $roles  = Rol::all();
        $ciudades  = Ciudad::all();
        return view('admin.user.add',[ 'ciudades' => $ciudades, 'roles' => $roles]);
    }
    ...
    public function show($id)
    {
      ...
      return view('admin.user.ver',compact('adminUser'));
    }
    ...
    public function edit($id)
    {
      ...
      $roles  = Rol::all();
      $ciudades  = Ciudad::all();
      return view('admin.user.update', compact('adminUser'),[ 'ciudades' => $ciudades, 'roles' => $roles] );
    }
