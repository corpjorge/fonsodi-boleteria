...
class ConfigAreasAdminItemController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('admin.areas_admin_item.areas', [ 'area_item_admins' => $area_item_admins]);
    }
    ...
    public function create()
    {
      ...
      return view('admin.areas_admin_item.add', [ 'area_admins' => $area_admins]);
    }
    ...
    public function edit($id)
    {
      ...
      return view('admin.areas_admin_item.update', compact('area_item_admins'), [ 'area_admins' => $area_admins]);
    }
