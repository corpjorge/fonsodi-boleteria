...
class ConfigPermisosController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('admin.permisos.permisos',[ 'permisos' => $permisos]);
    }
    ...
    public function create()
    {
      ...
      return view('admin.permisos.add',[ 'area_admins' => $area_admins, 'adminUsers' => $adminUsers ]);
    }
    ...
    public function show($id)
    {
      ...
      return view('admin.permisos.ver',compact('permiso'));
    }
    ...
    public function edit($id)
    {
      ...
      $area_admins  = Area_admin::all();
      $adminUsers  = AdminUser::all();
      return view('admin.permisos.update', compact('permiso'),[ 'area_admins' => $area_admins, 'adminUsers' => $adminUsers ] );
    }
