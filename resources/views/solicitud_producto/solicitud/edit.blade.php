                  ...
                  <form role="form" action="{{ url('solicitudes/solicitados/ver/'.$row->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">                      
                      ...
                      <div class="form-group">
                        ...
                        <input style="color: black;" type="number" class="form-control" id="" name="monto" placeholder="$ 10000" min="1" max="" value="{{$row->monto}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Meses</label>
                        <input style="color: black;" type="number" class="form-control" id="" name="cuota" placeholder="6" min="1" max="" value="{{$row->cuotas}}">
                      </div>
                      <div class="form-group">
