    ...
    <div id="app">
        <div class="register-box">
            <div class="register-logo">
                <a href="{{ url('/home') }}"><b>Coop</b>Fon</a>
            </div>
            ...
            <div class="register-box-body">
                ...
                <form action="{{ url('/register') }}" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input style="color:black" type="text" class="form-control" placeholder="{{ trans('message.fullname') }}" name="name" value="{{ old('name') }}"/>
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input style="color:black" type="email" class="form-control" placeholder="{{ trans('message.email') }}" name="email" value="{{ old('email') }}"/>
