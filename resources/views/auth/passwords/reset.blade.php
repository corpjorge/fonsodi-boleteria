        ...
        <div class="login-box-body">
            ...
            <form action="{{ url('/password/reset') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input style="color:black" type="email" class="form-control" placeholder="Email" name="email" value="{{ old('email') }}"/>
                ...
                <div class="form-group has-feedback">
                    <input style="color:black" type="password" class="form-control" placeholder="Password" name="password_confirmation"/>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
